...
<head>
   ...
   <body>
         ...
         <form action="saveupdaterec.php" method="post">
               ...
               <input type="text" name="price" id="price" placeholder="Product Price" value=<?php echo $_REQUEST["email"];  ?>>
               <label for="addres">Product Description:</label></td><td>
               <input type="text" name="desc" id="desc" placeholder="Product Description" value=<?php echo $_REQUEST["address"];  ?>>
